...
____  _______  _______  _______  _______  _______
                                                   '''
	print(f'{G}{art}{W}\n')
	print(f'{G}[>] {C}Created By   : {W}Rohan Nahak')
	print(f'{G} |---> {C}Instagram : {W}https://rohan_nahak.h.r')
	print(f'{G} |---> {C}Community : {W}https://www.scaninfoga.com')
	print(f'{G}[>] {C}Version R+S  : {W}Live-Tracker 5.1')
